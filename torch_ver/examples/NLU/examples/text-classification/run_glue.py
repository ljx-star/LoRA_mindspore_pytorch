...
class ModelArguments:
    ...
    cls_dropout: Optional[float] = field(
        default=0.1,
        metadata={"help": "Dropout probability for classification head."}
    )
    use_deterministic_algorithms: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to use deterministic algorithms for reproducibility."}
    )
...
def main():
    ...
    torch.use_deterministic_algorithms(model_args.use_deterministic_algorithms)
